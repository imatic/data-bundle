...
`query object documentation <docs/AccessingData/QueryObjects.rst>`_.
...
To learn more about commands, see `command documentation <docs/Operations/Commands.rst>`_.

Further reading
---------------

Visit our `documentation <docs/README.rst>`_ to learn about all features of this bundle.
