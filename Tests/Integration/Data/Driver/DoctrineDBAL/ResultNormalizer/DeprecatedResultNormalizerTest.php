...
use Imatic\Bundle\DataBundle\Data\Driver\DoctrineDBAL\ResultNormalizer\DeprecatedResultNormalizer;
use Imatic\Bundle\DataBundle\Tests\Fixtures\TestProject\WebTestCase;

class DeprecatedResultNormalizerTest extends WebTestCase
{
...
SQL
        ...
        $this->assertEquals(
            [
                [
                    ...
                    'birth_date' => new \DateTime('1990-01-01 00:00:00'),
                    'favorite_day' => new \DateTime('2013-05-03'),
                    'renamed_fav_time' => '05:32:00', // this can't be converted anymore as it's aliased
                    'hairs' => 'short',
                ],
            ],
            $result
    ...
    {
        return self::$container->get('imatic_data.tests.' . DeprecatedResultNormalizer::class);
    }
